...
public class Block implements Disposable{
	...
	private ArrayList<Block> connections = new ArrayList<Block>();
	private double ID;
	...
	public void setDistanceToGoal(int i)
	{
		distanceToGoal=i;
	}
	...
	public void addConnection(Block b)
	{
		connections.add(b);
	}
	public ArrayList<Block> getConnections()
	{
		return connections;
	}
	public enum Type {
